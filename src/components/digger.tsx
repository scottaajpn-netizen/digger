...
export function Digger({ initial }: { initial: DigResponse | null }) {
  ...
  return <div className="app-shell">
    ...
    <main><section className="hero"><div className="hero-copy-block"><p className="eyebrow hero-catalog"><span>D / RECORDS</span> VOL. 001 · 33⅓ RPM</p><h1><span>KEEP</span><br /><em>DIGGING</em></h1><p className="hero-copy">Un morceau mène à un autre.<br />Labels, crédits, détours.</p></div><div className="record-illustration" aria-hidden="true"><div className="record-sleeve abstract-sleeve"><div className="sleeve-meta"><b>DIGGER</b><small>VOL. 001</small></div><div className="sleeve-art"><span /><span /><span /><i /></div><small>D / RECORDS · KEEP DIGGING</small></div><div className="vinyl"><span>dig<br />deeper<small>33⅓ RPM</small></span></div><div className="record-sticker">KEEP DIGGING.</div></div></section>
